...
import kmine.tile.Tile

class Level: ChunkManager, Metadatable {
    companion object {
        private val levelIdCounter = 1
        private val chunkLoaderCounter = 1

        public const val Y_MASK = 0xFF
        public const val Y_MAX = 0x100 //256

        public const val BLOCK_UPDATE_NORMAL = 1
        public const val BLOCK_UPDATE_RANDOM = 2
        public const val BLOCK_UPDATE_SCHEDULED = 3
        public const val BLOCK_UPDATE_WEAK = 4
        public const val BLOCK_UPDATE_TOUCH = 5

        public const val TIME_DAY = 0
        public const val TIME_SUNSET = 12000
        public const val TIME_NIGHT = 14000
        public const val TIME_SUNRISE = 23000

        public const val TIME_FULL = 24000

        public const val DIFFICULTY_PEACEFUL = 0
        public const val DIFFICULTY_EASY = 1
        public const val DIFFICULTY_NORMAL = 2
        public const val DIFFICULTY_HARD = 3
    }

    /** @var Tile[] */
    private val tiles = emptyList<Tile>()
    ...
    /** @var Tile[] */
    public val updateTiles =  emptyArray<Tile>()
    /** @var Block[][] */
    private $blockCache = []
     ...
     * @throws \Exception
     */
    public function __const valruct(Server $server, string $name, string $path, string $provider){
